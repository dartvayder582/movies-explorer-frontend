        ...
        <div className='footer__copyright-content'>
          ...
          <ul className='footer__links list-style'>
            <li className='footer__link'>
              <a href="https://practicum.yandex.ru/" target="_blank" className='footer__font link-style' rel="noreferrer">Яндекс.Практикум</a>
            </li>
            <li className='footer__link'>
              <a href="https://github.com/" target="_blank" className='footer__font link-style' rel="noreferrer">Github</a>
            </li>
          </ul>
        </div>
      </div>
